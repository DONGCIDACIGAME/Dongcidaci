...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\rHeroCfg.proto\x12\nConfigData\"7\n\x0bHeroBaseCfg\x12\n\n\x02ID\x18\x01 \x01(\r\x12\x0c\n\x04name\x18\x02 \x01(\t\x12\x0e\n\x06prefab\x18\x03 \x01(\t\"\xab\x01\n\x0cHeroCfg_Data\x12I\n\x11HeroBaseCfg_items\x18\x01 \x03(\x0b\x32..ConfigData.HeroCfg_Data.HeroBaseCfgItemsEntry\x1aP\n\x15HeroBaseCfgItemsEntry\x12\x0b\n\x03key\x18\x01 \x01(\r\x12&\n\x05value\x18\x02 \x01(\x0b\x32\x17.ConfigData.HeroBaseCfg:\x02\x38\x01\x42#\n!com.trinitigames.server.conf.autob\x06proto3'
)
...
_HEROBASECFG = _descriptor.Descriptor(
  name='HeroBaseCfg',
  full_name='ConfigData.HeroBaseCfg',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='ID', full_name='ConfigData.HeroBaseCfg.ID', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='ConfigData.HeroBaseCfg.name', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='prefab', full_name='ConfigData.HeroBaseCfg.prefab', index=2,
...
_HEROCFG_DATA_HEROBASECFGITEMSENTRY = _descriptor.Descriptor(
  ...
  full_name='ConfigData.HeroCfg_Data.HeroBaseCfgItemsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='ConfigData.HeroCfg_Data.HeroBaseCfgItemsEntry.key', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='ConfigData.HeroCfg_Data.HeroBaseCfgItemsEntry.value', index=1,
...
_HEROCFG_DATA = _descriptor.Descriptor(
  name='HeroCfg_Data',
  full_name='ConfigData.HeroCfg_Data',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='HeroBaseCfg_items', full_name='ConfigData.HeroCfg_Data.HeroBaseCfg_items', index=0,
...
HeroBaseCfg = _reflection.GeneratedProtocolMessageType('HeroBaseCfg', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:ConfigData.HeroBaseCfg)
  })
...
HeroCfg_Data = _reflection.GeneratedProtocolMessageType('HeroCfg_Data', (_message.Message,), {
  ...
  'HeroBaseCfgItemsEntry' : _reflection.GeneratedProtocolMessageType('HeroBaseCfgItemsEntry', (_message.Message,), {
    ...
    '__module__' : 'HeroCfg_pb2'
    # @@protoc_insertion_point(class_scope:ConfigData.HeroCfg_Data.HeroBaseCfgItemsEntry)
    })
  ,
  'DESCRIPTOR' : _HEROCFG_DATA,
  '__module__' : 'HeroCfg_pb2'
  # @@protoc_insertion_point(class_scope:ConfigData.HeroCfg_Data)
  })
