...
public class GameManager:MonoBehaviour
{
    ...
    private void Test()
    {
        ...
        //BTInvertNode invertNode = new BTInvertNode();
        //invertNode.NodeName = "InvertNodeName";
        //invertNode.NodeDesc = "InVertNodeDesc";

        //BTSequenceNode sequenceNode2 = new BTSequenceNode();
        //sequenceNode2.NodeName = "SequenceNodeName2";
        //sequenceNode2.NodeDesc = "SequenceNodeDesc2";


        //BTRepeatNode repeatNode2 = new BTRepeatNode();
        //repeatNode2.NodeName = "RepeatNodeName2";
        //repeatNode2.NodeDesc = "RepeatNodeDesc2";
        //repeatNode2.SetRepeatTime(1);

        //BTWaitTimeNode waitTimeNode2 = new BTWaitTimeNode();
        //waitTimeNode2.NodeName = "WaitTimeNodeName2";
        //waitTimeNode2.NodeDesc = "WaitTimeNodeDesc2";
        //waitTimeNode2.SetWaitTime(1);


        //BTWaitFrameNode waitFrameNode2 = new BTWaitFrameNode();
        //waitFrameNode2.NodeName = "WaitFrameNodeName2";
        //waitFrameNode2.NodeDesc = "WaitFrameNodeDesc2";
        //waitFrameNode2.SetWaitFrame(1);

        //sequenceNode.AddChildNode(invertNode);
        //invertNode.SetChildNode(sequenceNode2);
        //sequenceNode2.AddChildNode(repeatNode2);
        //repeatNode2.SetChildNode(waitTimeNode2);
        //sequenceNode2.AddChildNode(waitFrameNode2);
