...
public static class InputDef
{
    ...
    public const string AgentKeyboardInputHandle_AttackTransition           = "AgentKeyboardInputHandle_AttackTransition";
    public const string AgentKeyboardInputHandle_Charging                   = "AgentKeyboardInputHandle_Charging";
    public const string AgentKeyboardInputHandle_ChargingTransition         = "AgentKeyboardInputHandle_ChargingTransition";
    ...
    public const string AgentKeyboardInputHandle_Dead                       = "AgentKeyboardInputHandle_Dead";
