...
public class ControlCheckInStatusPropertyPage : ControlAINodePropertyPage
{
    ...
    protected override void BindUINodes()
    {
        ...
        Dropdown_StatusType = BindDropDownNode("Dropdown_StatusType", new List<TMP_Dropdown.OptionData>()
        {
            ...
            new TMP_Dropdown.OptionData(AgentStatusDefine.ATTACK_TRANSITION),
    ...
    private void OnSelectTargetStatus(int index)
    {
        ...
        switch(index)
        {
            ...
            case 3:
                ...
                break;
            case 4:
                targetStatus = AgentStatusDefine.ATTACK_TRANSITION;
                break;
            case 5:
        ...
        if (node == null)
    {
        ...
        else if (AgentStatusDefine.ATTACK_TRANSITION.Equals(targetStatus))
        {
            index = 4;
        }
