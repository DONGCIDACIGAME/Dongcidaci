...
public static class BehaviourTreeHelper
{
    ...
    /// <returns></returns>
    public static BTNode CreateBTNode(BTNodeData data)
    {
        if (data == null)
        {
            Log.Error(LogLevel.Normal, "BehaviourTreeHelper CreateBTNode Failed, node data is null!");
            return null;
        }
    ...
    /// ---------------------------增加新节点时需要更新
    /// <returns></returns>
    public static BTNode CreateBTNode(int nodeType, int nodeDetailType)
    {
        ...
        Log.Error(LogLevel.Normal, "BehaviourTreeHelper CreateBTNode Failed, nodeType:{0}, nodeDetailType:{1}, no matching class!", nodeType, nodeDetailType);
        return null;
    }
